...
router.post('/', function (req, res, next) {
  ...
  createHuman(request, function (str) {
    ...
    var father_name = str.父亲姓名;
     ...
     var query="insert into create_check(check_id,father_name,father_id,mother_name,mother_id,marry_cert,birth_id,birth_date,sex,hospital_id,checkflag,if_managed,if_look)values('"+check_id+"','"+father_name+"','"+father_id+"','"+mother_name+"','"+mother_id+"','"+marry_cert+"','"+birth_id+"','"+birth_date+"','"+sex+"','"+hospital_id+"','"+check+"',0,0"+");";
    console.log(str);
    console.log("==========================="+query);
